...
/**
 * StudentHome:
 * - Puxa tickets do backend e exibe em lista
 * - Botão "Atualizar"
 * - (Opcional) depois você filtra por student_id quando tiver login real
 */
export default function StudentHome() {
  ...
  return (
    <View style={styles.container}>
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <Text style={{ marginTop: 16, color: "#666" }}>
              Nenhum ticket encontrado. Verifique o BASE_URL no src/services/api.js.
            </Text>
          }
        />
      )}
      ...
      <TouchableOpacity
        style={styles.bigBtn}
        onPress={() => alert("Aqui depois vira um POST /tickets pra gerar o ticket do dia 🙂")}
        activeOpacity={0.85}
      >
